...
export const CONFIG = {
  ...
  player: {
    ...
    airAcceleration: 0.4,
    airDeceleration: 0.3,
    maxRunSpeed: 3.6,             // walking = the Grinch's sneak
    maxSprintSpeed: 6.5,          // sprint = full run
    ...
    // Dimensions (Grinch default; Max overrides in player.js)
    width: 24,
    height: 36,
  ...
  enemies: {
    ...
    flyguy: {
      ...
      verticalSpeed: 0.03,
      bounceVelocity: -8,
      patrolRange: 128,      // stays within 4 tiles of its perch
    },
    spiker: {
      width: 30,
      height: 30,
