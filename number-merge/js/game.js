...
export class Game {
  ...
  // You lose by *leaving* a block above the line. Each block carries its own
  ...
  //
  // The hold is the whole point. A block squeezed out of the pile can fly far
  // above the rim and take well over the grace period to come back down; timing
  // that flight as if the block had been abandoned up there ended the game on a
  // bounce. And holding rather than clearing means a block that pops up and
